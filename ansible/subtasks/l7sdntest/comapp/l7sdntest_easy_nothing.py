...
# helper methods
    ...
    def db_connect(self):
        try:
            if self.db_con == None:
                self.db_con = lite.connect('/home/user/l7sdntest/src/comappdb.sqlite')
...
# EVENTS
    ...
    def packet_in_handler(self, ev):
        ...
        while ipv4_msg != None:
            ...
            if src_tcp >= 29000 and src_tcp < 30000 and dst_tcp >= 30000 and dst_tcp < 31000:
            ...
            if src_tcp >= 30000 and src_tcp < 31000 and dst_tcp >= 29000 and dst_tcp < 30000:
