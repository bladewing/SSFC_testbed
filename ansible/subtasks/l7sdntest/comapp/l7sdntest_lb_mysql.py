...
class L7sdntestSwitch(app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        ...
        # DEBUG!!!!
        self.db_connect()
        query = self.db_query('SELECT VERSION()')
        data = query.fetchone()
...
# helper methods
    ...
    def db_connect(self):
        if self.db_con == None:
            self.db_con = MySQLdb.connect(host="localhost",    # your host, usually localhost
                                 user="root",         # your username
                                 passwd="root",       # your password
                                 db="l7sdntest")      # name of the data base
